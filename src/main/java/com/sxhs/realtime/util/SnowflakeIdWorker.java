...
public class SnowflakeIdWorker {
     ...
     * @return
     */
    public static String generateIdReverse(){
        return new StringBuffer(String.valueOf(idWorker.nextId())).reverse().toString();
    }
...
//        }
        System.out.println(String.valueOf(SnowflakeIdWorker.generateId()));
    }
